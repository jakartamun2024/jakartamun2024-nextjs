  ...
  return (
    <div className="bg-orange-200 lg:w-[85%] md:w-[85%] sm:w-[95%] w-[95%] min-h-screen rounded-xl justify-self-center flex lg:flex-col flex-col">
      <div className="container mx-auto my-auto p-4 w-4/6 py-8">
        <iframe
          src="https://docs.google.com/forms/d/e/1FAIpQLSf0125sMIKCVQsByunLjtZ8Gj1kv82Qkyh4-Ly2YaDEFOhFIA/viewform?embedded=true"
          ...
          <div className="space-y-12">
            <div className="border border-black pb-12">
              ...
              <p className="mt-1 text-sm leading-6 text-gray-600">
                Please fill in your data accordingly.
              </p>

              <div className="border border-blue-900 mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
