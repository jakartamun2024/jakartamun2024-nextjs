  ...
  return (
    <div>
      ...
      <div className="w-screen flex items-center justify-center py-36 pb-12">
        ...
        <div className={`z-20 ${poppins.className}`}>
          <iframe
            width="560"
            height="315"
      ...
      <div className="w-full items-center justify-center">
        <div className="absolute min-h-fit w-screen bg-[#DF6A26]">
          <div className="min-h-fit bg-gradient-to-b from-[#DF6A26] to-[#f55789]">
            <h1
              className={`text-4xl md:text-5xl lg:text-7xl text-center text-transparent bg-clip-text bg-gradient-to-b drop-shadow-md from-white to-[#faca6b] font-extrabold m-5`}
              ref={aboutRef}
            >
              ABOUT JMUN
            </h1>
