          ...
          >
            ...
            <div className="p-10 lg:px-40">
              <p className="md:text-lg">
                ...
                <strong>JMUN</strong>”) is an annual MUN conference held by the
                Indonesian Student Association for International Studies (“
                <strong>ISAFIS</strong>”), one of the biggest and most
            ...
            <div className="p-10 lg:px-40">
              ...
              <p className="md:text-lg">
                ...
                as its primary color, symbolizing cultural icons such as the
                renowned <em>Ondel-Ondel</em> and the distinctive Jakarta
                transportation, <em>Bajaj</em>. Additionally, JMUN 2024
            ...
            <div className="p-10 lg:px-40 pb-32">
              <p className="md:text-lg">
                ...
                collaboration and partnership with numerous stakeholders,
                ranging from fellow youth organizations, non-governmental
                organizations, embassies, government institutions, and
                international organizations to support its programs such as
                Jakarta Model United Nations, Indonesia International Week,
                Jakarta Youth Summit and other annual programs. As a youth
                organization, ISAFIS attempts to give many advantages for the
                youth themselves, as well as for the entire community through
                our programs. Particularly, we try to develop important personal
                and interpersonal skills of the members, offer opportunities for
                them through conferences, summits, exchange programs, and
                involving youth to develop their leadership potential, so that
                as they grow and learn they can become thoughtful, prepared
                leaders of the society. Hence, in line with the ISAFIS vision
                mission statement, we would like to develop the members and
                advance ISAFIS as a leading youth organization by facilitating
                personal growth and development for members through a series of
                integrated programs and activities, and building and widening
                external partnerships with the domestic and international
                institutions.
              </p>
            </div>
          </div>
