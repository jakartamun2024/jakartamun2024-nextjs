    ...
    <div className={`w-full ${poppins.className} bg-black bg-opacity-50`}>
      <div className="flex flex-col w-full px-3 md:w-2/3 md:p-0 mx-auto divide-y-2 divide-white gap-16 ">
        ...
        <div className="pt-16">
          ...
          <div className="flex flex-col-reverse md:flex-row-reverse items-center">
            <p className="basis-2/3 text-justify">
              ...
              regarding the tourism challenges facing the world. UNWTO
              identifies the ability of the tourism sector to be better and
              positive, including the tourism sector that focuses on the
              progress of the 17 Sustainable Development Goals (SDGs). Beyond
              the SDGs, the UNWTO is spirited in actuating their 2018 Management
              Vision, which comprises of five pillars: (1) actuating
              innovation-based tourism; (2) increasing the competitiveness of
              the tourism sector at every level and scale by expanding the
              number of investments and entrepreneurial actors; (3) creating
              jobs and provide relevant training to increase absorption of
          ...
          <p className="text-justify">
            (4) creating resilient, safe, and smooth tourism travel; and (5)
            maximize the unique potential of the tourism sector in protecting
            cultural and natural heritage, all the while giving socioeconomic
            support to surrounding communities. The Organization is a major
            player in safeguarding the resilience of cultural tourism worldwide
            - as seen through the Istanbul Declaration, highlighting the need
            for collaboration between cultural tourism and local community
          ...
          <p className="text-justify mt-2">
            ...
            sector of tourism sustainable? May it be revenue volatility,
            enterprise-driven exploitation, or social changes due to the influx
            of tourists, cultural tourism has been criticized for being
            unsustainable. Most concerningly, management of cultural tourism has
            arguably forgotten one of its core purposes, being to safeguard and
            promote the appreciation of local cultures. Hence, Member States are
            urged to not only bridge the dissenting views surrounding
            sustainable cultural tourism, but to also consider the views of
            native communities.
          </p>
        </div>
        {/* ====== UNWTO ====== */}
        ...
        <div className="pt-16">
          ...
          <h2 className="text-2xl font-semibold pb-2">
            Offline - <span className="text-[#F8D488]">Intermediate</span> -
            Single Delegate
          </h2>
          <div className="flex flex-col-reverse md:flex-row items-center">
            <p className="basis-2/3 text-justify">
          ...
          <p className="text-justify">
            In what is called the UEFA Congress, the UEFA president and general
            secretaries from 55 member nations gather to discuss decisions,
            measures, and proposals on enhancing the European game. The output
            from these Congress meetings vary - being joint statements, annual
            reports, or Draft Communiques, all in which rely on the unanimous
            agreement of its associate members. Come and join us and be the
        ...
        <div className="pt-16">
          ...
          <div className="flex flex-col-reverse md:flex-row-reverse items-center">
            <p className="basis-2/3 text-justify">
              ...
              curated to improve water access and supply. The output of this
              Forum is to produce a global framework, proposed to raise
              awareness among decision-makers and the public, providing
              opportunities to develop new partnerships with shared visions on
              challenging water issues, and encouraging greater media attention
              for water issues along with their solutions.
            </p>
            <div className="basis-1/3">
              <Image
          ...
          <p className="text-justify">
            To achieve its aim successfully, the World Water Forum includes
            three phases, which are a three-year preparatory phase, a one-week
            event phase, and a synthesis phase at the end of the event. This
            year, Indonesia will host the tenth World Water Forum and the
            biggest one by far in terms of expected participants, which will
        ...
        <div className="pt-16">
          ...
          <h2 className="text-2xl font-semibold pb-2">
            Offline - <span className="text-[#B73225]">Advanced</span> - Single
            Delegate
            <br />
        ...
        <div className="pt-16">
          ...
          <h2 className="text-2xl font-semibold text-end pb-2">
            Offline - <span className="text-[#B73225]">Advanced</span> - Double
            Delegate
          </h2>
          <div className="flex flex-col-reverse md:flex-row-reverse items-center">
            <p className="basis-2/3 text-justify">
          ...
          <p className="text-justify">
            This council is also able to deploy peacekeepers, enact sanctions,
            authorize military actions, and revise the UN Charter when demanded.
            The United Nations is famous for its five permanent members: The
            USA, China, Russia, The UK, and France. These countries, known as
            the P5, have the power to veto any draft resolution that has been
            put forth by the council. Through the tools given by the United
            Nations Security Council, the committee urges the delegates to
            represent the stances and concerns of their respective countries,
        ...
        <div className="pt-16">
          ...
          <p className="text-justify mt-2">
            ...
            The War on Terror, #BlackLivesMatter movement, and the Mahsa Amini
            protests are several amongst many examples of “public emergencies”
            that justify rising frequencies of arrests made to “upkeep national
            peace”. Most of the people arrested during these “public
            instabilities” include Muslims, black people, as well as women
