...
function Section1() {
  return (
    <div className='bg-gradient-to-r from-[#b23727] to-[#dc7030] lg:w-[85%] md:w-[85%] sm:w-[95%] w-[95%] rounded-xl justify-self-center flex flex-col mx-auto p-1'>
      <div className='bg-[#f3f5d8] lg:bg-gradient-to-r lg:from-[#f3f5d8] lg:from-30% lg:to-[#dc7030] lg:to-70%  min-h-96 rounded-lg justify-self-center flex lg:flex-row flex-col px-2'>
