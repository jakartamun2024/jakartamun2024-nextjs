  ...
  return (
    ...
    >
      ...
      <div className="flex-1 pl-2">
        <h1
          className={`text-2xl line-clamp-2 pb-2 leading-5 text-start md:pb-0 md:leading-normal ${dmSerif.className}`}
        >
          {title}
        </h1>
        <p className="line-clamp-3 text-sm leading-4 md:leading-normal">
          {desc}
        </p>
