...
export default function CouncilDropdown(props: any) {
  const router = useRouter();
  const path = usePathname();

  function toAbout() {
    if (path !== "/councils") {
      router.push("/councils?s=0");
    } else if (props.offlineRef && props.offlineRef.current) {
  ...
  function toGrand() {
    if (path !== "/councils") {
      router.push("/councils?s=1");
    } else if (props.onlineRef && props.onlineRef.current) {
