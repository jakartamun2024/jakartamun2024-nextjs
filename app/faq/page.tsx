...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div
        className={`${poppins.className} w-screen h-720 flex flex-col justify-center bg-gradient-to-b from-[#DF6A26] to-[#f55789] relative`}
      >
        <div className=" h-1/6 w-full">
          <Image
            ...
            quality={100}
            className="absolute z-0 top-0 h-1/5 w-full hidden md:block"
          />
        ...
        <div>
          ...
          <div className="flex flex-col">
            <div className="flex flex-row w-screen md:flex-row mx-auto md:w-1/2 justify-around px-2">
              <div className=" mt-32">
                <h1
                ...
                <div
                  className="  hidden md:block bottom-4 z-50 font-semibold  text-center">
                  <p>
                    Photo by{" "}
                    <a
